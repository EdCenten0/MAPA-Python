...
class Ui_mw_materiales(object):
    def setupUi(self, mw_materiales):
        ...
        self.txtPrecioTotal = QtWidgets.QLineEdit(self.centralwidget)
    ...
    def retranslateUi(self, mw_materiales):
        ...
        self.cbUnidadesMedida.setItemText(1, _translate("mw_materiales", "Lts"))
        self.cbUnidadesMedida.setItemText(2, _translate("mw_materiales", "Mts"))
        self.cbUnidadesMedida.setItemText(3, _translate("mw_materiales", "Inches"))
        ...
        self.cbUnidadesMedida.setItemText(6, _translate("mw_materiales", "Simple"))
